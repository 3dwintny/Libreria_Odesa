    ...
    @csrf
        ...
        <br>
            ...
            <div class="row g-3 align-items-center">
                ...
                <div class="col-auto">
                    <input type="number" id="cantidadLibros" name="cantidadLibros" class="form-control" value="1">
                </div>
                <div class="col-auto">
                    <label class="col-form-label">Precio</label>
                </div>
                <div class="col-auto">
                    <input type="text" id="precioCompraLibro" name="precioCompraLibro" class="form-control" placeholder="Precio de Compra">
                </div>
                <div class="col-auto">
                    <button 
                        type="button" class="btn" 
                        style="background-color: #328CC1; 
...
<script>
    ...
    function agregar(){
        ...
        if(libro_id!="" && cantidadLibros!="" && cantidadLibros>0 && precioCompraLibro!=""){
            ...
            var fila = '<tr class="selected" id="fila'+cont+'"><td><button type="button" class="btn btn-danger btn-sm" onclick="eliminar(' + cont + ');">X</button></td> <td><input type="hidden" name="libro_id[]" value="' + libro_id + '">' + libro + '</td> <td><input type="hidden" id="precioCompraLibro[]" name="precioCompraLibro[]" value="' + precioCompraLibro + '"> <input class="form-control" type="number" id="precioCompraLibro[]" value="' + precioCompraLibro + '" disabled></td> <td><input type="hidden" name="cantidadLibros[]" value="'+ cantidadLibros +'"><input class="form-control" type="number" value="' + cantidadLibros + '" disabled></td> <td align="right">Q'+subtotal[cont] + ' </td></tr>';    
            cont++;
            limpiar();
            totales();
            evaluar();
