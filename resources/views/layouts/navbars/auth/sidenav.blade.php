<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="#navbar-libros" data-toggle="collapse" role="button"
                ...
                <div class="collapse show" id="navbar-libros">
            ...
            <!-- Esta parte la dejaremos para el final o para los reportes  -->
